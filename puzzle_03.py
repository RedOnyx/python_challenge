...
"""
#One small letter, surrounded by EXACTLY three big bodyguards on each of its sides
#searchObj = re.compile(r'[A-Z]{3}[a-z]{1}[A-Z]{3}')
#searchObj = re.search(r'[A-Z]{3}[a-z][A-Z]{3}', Large_Text)


def find_keyword(text):
    matches = re.findall(r'[^A-Z][A-Z]{3}[a-z]{1}[A-Z]{3}[^A-Z]', text)
    output = ''
    for i in matches:
        output += i[4]
    return output
...
if __name__ == "__main__":
    answer = find_keyword(Large_Text)
    print("Challenge: One small letter, surrounded by EXACTLY three big bodyguards on each of its sides.")
    print("Answer: {}".format(answer))
    print("Next challenge url: http://www.pythonchallenge.com/pc/def/{}.html".format(answer))
